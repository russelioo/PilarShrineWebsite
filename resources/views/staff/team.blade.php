...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="actions">
            <button class="btn btn-outline">ðŸ“¥ Export</button>
            <button class="btn btn-primary">ï¼‹ Add Staff Member</button>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-icons">
                        <a href="#" title="View">ðŸ‘</a>
                        <a href="#" title="Edit">âœŽ</a>
                        <a href="#" title="Reset Password">ðŸ”‘</a>
                        <a href="#" title="Delete" style="color:#c0392b">âœ•</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-top:18px;font-size:11px;color:var(--muted)">
        ...
        <div style="display:flex;gap:4px">
            <button style="padding:6px 12px;border:1px solid var(--line);border-radius:5px;background:#fff;cursor:pointer">â€¹</button>
            ...
            <button style="padding:6px 12px;border:1px solid var(--line);border-radius:5px;background:#fff;cursor:pointer">â€º</button>
        </div>
    </div>
@endsection
