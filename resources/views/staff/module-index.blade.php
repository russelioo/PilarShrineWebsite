...
@push('styles')
<style>
.page-header>div{min-width:0}.view-only-label{padding:7px 10px;border-radius:20px;background:#eaf2fb;color:var(--navy);font-size:9px;font-weight:700;text-transform:uppercase}.page-description{margin:6px 0 0;color:var(--muted);font-size:11px}.module-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:18px}.module-summary article{padding:16px 18px;border:1px solid var(--line);border-radius:9px;background:#fff}.module-summary strong,.module-summary span{display:block}.module-summary strong{color:var(--navy);font-family:var(--font-heading);font-size:20px;font-weight:700}.module-summary span{margin-top:5px;color:var(--muted);font-size:9px;text-transform:uppercase}.toolbar{display:flex;gap:10px;margin-bottom:18px}.toolbar input,.toolbar select{padding:10px 12px;border:1px solid var(--line);border-radius:7px;background:#fff;font-size:11px}.toolbar input{flex:1;min-width:180px}.table-wrap{overflow-x:auto;border:1px solid var(--line);border-radius:11px;background:#fff}table{width:100%;border-collapse:collapse;font-size:11px}th,td{padding:13px 15px;text-align:left;border-bottom:1px solid #edf2f7;white-space:nowrap}th{background:#f7fafc;color:var(--muted);font-size:9px;text-transform:uppercase}tbody tr:last-child td{border-bottom:0}.row-actions{display:flex;gap:10px}.row-actions a{color:var(--blue);font-weight:700;text-decoration:none}.static-note{color:var(--muted);font-size:10px}@media(max-width:620px){.page-header{align-items:flex-start;gap:12px}.module-summary{grid-template-columns:1fr}.toolbar{flex-wrap:wrap}.toolbar input{min-width:100%}}
</style>
@endpush