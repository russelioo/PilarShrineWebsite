...
<body>
    <div class="layout">
        ...
        <main class="main">
            <!-- Top Bar -->
            <x-staff-topbar :title="$title ?? 'Dashboard'" />
    ...
    <script>
        (() => {
            ...
            setCollapsed(localStorage.getItem('staff-sidebar-collapsed') === 'true');
            toggle.addEventListener('click', () => {
                hideTooltip();
                const collapsed = !layout.classList.contains('sidebar-collapsed');
                setCollapsed(collapsed);
                localStorage.setItem('staff-sidebar-collapsed', String(collapsed));
            });
        })();
    </script>
    <!-- Scripts -->
